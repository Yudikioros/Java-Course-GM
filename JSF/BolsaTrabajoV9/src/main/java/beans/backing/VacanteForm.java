...
public class VacanteForm extends Object {
    ...
    public void codigoPostalListener(ValueChangeEvent e) {
        ...
        int nuevoCP = ((Long) e.getNewValue()).intValue();
            UIInput coloniaIdInputText = (UIInput) viewRoot.findComponent("vacanteForm:coloniaId");
            int coloniaId = this.coloniaHelper.getColoniaIdPorCodigoPostal(nuevoCP);
