 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://service.sga.gm.com.mx/", wsdlLocation = "http://localhost:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://service.sga.gm.com.mx/", "PersonaServiceImplService");
    ...
    public PersonaServiceWS getPersonaServiceImplPort() {
        return super.getPort(new QName("http://service.sga.gm.com.mx/", "PersonaServiceImplPort"), PersonaServiceWS.class);
    }
    ...
    public PersonaServiceWS getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.sga.gm.com.mx/", "PersonaServiceImplPort"), PersonaServiceWS.class, features);
    }
